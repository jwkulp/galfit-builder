...
from ..components.sersic import Sersic
...
def build_sersic(
    ...
    defaults = config["defaults"]["sersic"]
    overrides = config.get("overrides", {}).get("sersic", {})
    ...
    return Sersic(
        ...
        eff_rad=GalfitParam(geom.a, settings.get("eff_rad_freeze")),
        sersic_index=GalfitParam(settings.get("sersic_index"), settings.get("sersic_index_freeze")),
